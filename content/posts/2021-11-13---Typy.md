...
kroku. Dlatego właśnie klasom przyjrzymy się bliżej jako pierwszym.
...
Dosyć ważną kwestią jest też konwencja nazw w Javie. Tworząc nową klasę nazwę piszemy izw. CamelCasem, czyli kolejne wyrazy piszemy łącznie, rozpoczynając każdy kolejny wielką literą np. `public class MyCar`.
